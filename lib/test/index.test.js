...
var mobx_command_1 = require("mobx-command");
...
describe('@trackAsyncNested can track methods on objects like command.execute', function () {
    var noop = function () { };
    var TestSubject = /** @class */ (function () {
        function TestSubject() {
            var _this = this;
            this.commandCancelsNonLatestAndSwallowsError = mobx_command_1.command(function (finalAction) { return __awaiter(_this, void 0, void 0, function () {
                var asyncRunTracker;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            asyncRunTracker = index_1.getCurrentRunTracker(this, 'commandCancelsNonLatestAndSwallowsError');
                            return [4 /*yield*/, delay()];
                        case 1:
                            _a.sent();
                            asyncRunTracker.throwCancelationIfRunNotLatest();
            ...
            this.commandCancelsNonLatestAndDoesNotSwallowsError = mobx_command_1.command(function (finalAction) { return __awaiter(_this, void 0, void 0, function () {
                var asyncRunTracker;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            asyncRunTracker = index_1.getCurrentRunTracker(this, 'commandCancelsNonLatestAndDoesNotSwallowsError');
                            return [4 /*yield*/, delay()];
                        case 1:
                            _a.sent();
                            asyncRunTracker.throwCancelationIfRunNotLatest();
        ...
        __decorate([
            index_1.trackAsyncNested({ property: 'execute' }),
            __metadata("design:type", Object)
        ], TestSubject.prototype, "commandCancelsNonLatestAndSwallowsError", void 0);
        __decorate([
            index_1.trackAsyncNested({ property: 'execute', swallowCancelationException: false }),
            __metadata("design:type", Object)
        ], TestSubject.prototype, "commandCancelsNonLatestAndDoesNotSwallowsError", void 0);
        return TestSubject;
    }());
    var subject = new TestSubject();
    beforeEach(function () {
    ...
    it('will run to completion normally', function () { return __awaiter(_this, void 0, void 0, function () {
        var finished, resPromise, res;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    finished = false;
                    resPromise = subject.commandCancelsNonLatestAndSwallowsError.execute(function () { return finished = true; });
                    chai_1.expect(subject.commandCancelsNonLatestAndSwallowsError.isExecuting).to.equal(true);
                    chai_1.expect(subject.commandCancelsNonLatestAndSwallowsError.canExecuteCombined).to.equal(false);
                    return [4 /*yield*/, resPromise];
                case 1:
                    res = _a.sent();
                    chai_1.expect(subject.commandCancelsNonLatestAndSwallowsError.isExecuting).to.equal(false);
                    chai_1.expect(subject.commandCancelsNonLatestAndSwallowsError.canExecuteCombined).to.equal(true);
                    chai_1.expect(finished).to.equal(true);
                    chai_1.expect(res).to.equal(normalReturnA);
                    return [2 /*return*/];
            }
    ...
    it('allows tracking and cancelation if same method was run again on the instance', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    counter = 0;
                    p1 = subject.commandCancelsNonLatestAndSwallowsError.execute(function () { return counter += 1; });
                    p2 = subject.commandCancelsNonLatestAndSwallowsError.execute(function () { return counter += 1; });
                    return [4 /*yield*/, Promise.all([p1, p2])];
                case 1:
                    _a = _b.sent(), res1 = _a[0], res2 = _a[1];
                    chai_1.expect(res1).to.equal(undefined);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    counter = 0;
                    p1 = subject.commandCancelsNonLatestAndSwallowsError.execute(function () { return counter += 1; });
                    p2 = subject.commandCancelsNonLatestAndDoesNotSwallowsError.execute(function () { return counter += 1; });
                    return [4 /*yield*/, Promise.all([p1, p2])];
                case 1:
                    _a = _b.sent(), res1 = _a[0], res2 = _a[1];
                    chai_1.expect(res1).to.equal(normalReturnA);
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    counter = 0;
                    p1 = subject.commandCancelsNonLatestAndSwallowsError.execute(function () { return counter += 1; });
                    p2 = new TestSubject().commandCancelsNonLatestAndSwallowsError.execute(function () { return counter += 1; });
                    return [4 /*yield*/, Promise.all([p1, p2])];
                case 1:
                    _a = _b.sent(), res1 = _a[0], res2 = _a[1];
                    chai_1.expect(res1).to.equal(normalReturnA);
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    counter = 0;
                    cancelationWasNotSallowed = false;
                    subject.commandCancelsNonLatestAndDoesNotSwallowsError.execute(function () { return counter += 1; })
                        .catch(function () {
                        cancelationWasNotSallowed = true;
                    });
                    return [4 /*yield*/, subject.commandCancelsNonLatestAndDoesNotSwallowsError.execute(function () { return counter += 1; })];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, delay()];
                case 2:
    ...
    it('does not swallow non-cancelation exceptions', function () { return __awaiter(_this, void 0, void 0, function () {
        var errorWasNotSallowed, marker, e_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    errorWasNotSallowed = false;
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, subject.commandCancelsNonLatestAndSwallowsError.execute(function () { throw new Error(marker); })];
                case 2:
                    _a.sent();
                    expectNotToGetToThisLine();
                    return [3 /*break*/, 4];
                case 3:
                    e_5 = _a.sent();
                    errorWasNotSallowed = true;
                    chai_1.expect(e_5.message).to.equal(marker);
                    return [3 /*break*/, 4];
                case 4:
                    chai_1.expect(errorWasNotSallowed).to.equal(true);
                    return [2 /*return*/];
            ...
            switch (_a.label) {
                case 0:
                    Subject = /** @class */ (function () {
                        function Subject() {
                            var _this = this;
                            this.wrongMethod = mobx_command_1.command(function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    index_1.getCurrentRunTracker(this, 'decoy');
                                    return [2 /*return*/];
                                });
                            }); });
                            this.wrongTarget = mobx_command_1.command(function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    index_1.getCurrentRunTracker(new Subject(), 'wrongTarget');
                                    return [2 /*return*/];
                                });
                            }); });
                            this.retrievedTooLate = mobx_command_1.command(function () { return __awaiter(_this, void 0, void 0, function () {
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0: return [4 /*yield*/, delay()];
                                        case 1:
                        ...
                        __decorate([
                            index_1.trackAsyncNested({ property: 'execute' }),
                            __metadata("design:type", Object)
                        ], Subject.prototype, "wrongMethod", void 0);
                        __decorate([
                            index_1.trackAsyncNested({ property: 'execute' }),
                            __metadata("design:type", Object)
                        ], Subject.prototype, "wrongTarget", void 0);
                        __decorate([
                            index_1.trackAsyncNested({ property: 'execute' }),
                            __metadata("design:type", Object)
                        ], Subject.prototype, "retrievedTooLate", void 0);
                        return Subject;
                    }());
                    s = new Subject();
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, s.wrongMethod.execute()];
                case 2:
                    _a.sent();
                    expectNotToGetToThisLine();
                    return [3 /*break*/, 4];
                case 3:
                    e_6 = _a.sent();
                    chai_1.expect(e_6.message.startsWith('You are trying to get current run tracker for method decoy')).to.equal(true);
                    return [3 /*break*/, 4];
                case 4:
                    _a.trys.push([4, 6, , 7]);
                    return [4 /*yield*/, s.wrongTarget.execute()];
                case 5:
                    _a.sent();
                    expectNotToGetToThisLine();
                    return [3 /*break*/, 7];
                case 6:
                    e_7 = _a.sent();
                    chai_1.expect(e_7.message.startsWith('Target passed does not match context of currenly starting trackAsyn method')).to.equal(true);
                    return [3 /*break*/, 7];
                case 7:
                    _a.trys.push([7, 9, , 10]);
                    return [4 /*yield*/, s.retrievedTooLate.execute()];
                case 8:
                    _a.sent();
                    expectNotToGetToThisLine();
                    return [3 /*break*/, 10];
                case 9:
                    e_8 = _a.sent();
                    chai_1.expect(e_8.message.startsWith('You are trying to get current run tracker while no run is starting')).to.equal(true);
                    return [3 /*break*/, 10];
                case 10: return [2 /*return*/];
            }
        });
