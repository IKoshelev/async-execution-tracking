...
function getCurrentRunTracker(target, methodName) {
    ...
    return {
        ...
        throwCancelationIfRunNotLatest: function () {
...
// tslint:disable-next-line:no-shadowed-variable
function trackAsyncNested(options) {
    var finalOptions = __assign({}, exports.defaultTrackAsyncOptions, options);
    return function (target, key) {
        ...
        var setter = function (newVal) {
            var currentTarget = this;
            _val = newVal;
            var originalFn = newVal[finalOptions.property];
            if (typeof originalFn !== 'function') {
...
exports.trackAsyncNested = trackAsyncNested;
